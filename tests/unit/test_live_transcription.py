...
def live_values(**overrides: object) -> dict[str, object]:
    values: dict[str, object] = {
        ...
        "firm_owned_openai_project_named": True,
        "openai_project_ownership_approved": True,
        "openai_project_data_controls_approved": True,
        "openai_provider_terms_approved": True,
        "generated_audio_test_approved": True,
        "transcription_live_execution_authorization_id": "owner-live-auth-unit-001",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("firm_owned_openai_project_named", False),
        ("openai_project_ownership_approved", False),
        ("openai_project_data_controls_approved", False),
        ("openai_provider_terms_approved", False),
        ("generated_audio_test_approved", False),
