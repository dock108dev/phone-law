...
ENGLISH_LONG_A_TEXT = " ".join(
    [
        "This is an invented scheduling exchange for an engineering test.",
        "One synthetic participant asks about a document checklist and a future callback.",
        "The participant pauses while the invented checklist is reviewed.",
    ]
)
ENGLISH_LONG_B_TEXT = " ".join(
    [
        "A different synthetic participant explains that a reviewer must confirm every detail.",
